...
**7. 哲学内核与天道规则** (重点):
- **阴阳五行**: 世界运转遵循阴阳相生、五行相克原理
- **因果报应**: 天道循环，善恶有报
- **无为而治**: 最高明的统治是不妄为，顺应民意
- **中庸之道**: 不偏不倚，恰到好处，避免极端
- **知行合一**: 理论领悟与实际行动的统一
- **格物致知**: 通过观察万物领悟天道真理
...
请以结构化的 JSON 格式输出，确保世界观设定逻辑自洽、细节丰富，并自然融入哲学思想。
""",
...
请为小说设计主要势力/组织，并体现不同哲学流派的核心理念:

**势力哲学定位 (重点):**
不同势力应体现不同的哲学流派，形成思想碰撞:

1. **道家门派** (无为而治):
   - 核心理念: 道法自然，无为而治，顺应天道
   - 修炼方式: 顺应自然，感悟天地，不强行逆天
   - 价值观: 柔弱胜刚强，上善若水，返璞归真
   - 特色: 注重心性修养，追求天人合一
